...
export default function Hero() {
  return (
    <section className="soft-grid relative overflow-hidden bg-[#f7faf8] pt-28">
      ...
      <div className="section-container grid min-h-[760px] items-center gap-12 py-10 lg:grid-cols-[0.86fr_1.14fr] lg:py-16">
        <div className="max-w-2xl">
          ...
          <h1 className="max-w-3xl text-4xl font-bold leading-[1.02] tracking-normal text-[#101513] sm:text-5xl lg:text-6xl">
            Reprenez le contrôle de votre gestion locative, sans tableurs, sans relances oubliées, sans dispersion.
          </h1>

          <div className="relative my-8 min-h-[260px] lg:hidden">
            <div className="absolute left-1/2 top-0 h-48 w-48 -translate-x-1/2 rounded-full bg-[#d8f2df] blur-3xl" />
            <div className="relative mx-auto w-full max-w-[680px]">
              <div className="overflow-hidden rounded-[32px] border border-[#dfe9e3] bg-white p-3 shadow-[0_28px_70px_rgba(16,21,19,0.16)]">
          ...
          <p className="mt-7 max-w-xl text-base leading-7 text-[#66736d] sm:text-lg">
        ...
        <div className="relative hidden min-h-[660px] lg:block lg:min-h-[740px]">
          <div className="absolute left-1/2 top-0 h-72 w-72 -translate-x-1/2 rounded-full bg-[#d8f2df] blur-3xl" />

          <div className="absolute left-1/2 top-[-40px] w-full max-w-[920px] -translate-x-1/2">
